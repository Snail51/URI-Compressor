...
curl "http://tools.snailien.net/URI-Compressor/api.php?cmpr=ZLIB&enc=URI-B64&data=eNrzSM3JyVcIzy_KSVEEABxJBD4"
...
curl -d "cmpr=ZLIB&enc=URI-B64&data=Hello%20World%21" -H "Content-Type: application/x-www-form-urlencoded" -X POST http://tools.snailien.net/URI-Compressor/api.php